        ...
        <el-form label-width="120px" @submit.native.prevent="save()">
            <el-tabs type="border-card">
                ...
                <el-tab-pane label="技能" name="skills">
                    <el-button type="samll" @click="model.skills.push({})"><i class="el-icon-plus"></i>添加技能</el-button>
                    <el-row type="flex" style="flex-wrap:wrap">
                        <el-col :md="12" style="margin-bottom:.5rem;" v-for="(item,index) in model.skills" :key="index">
                            <el-form-item label="名称">
            ...
            <el-form-item v-if="model.name" style="margin-top:1rem">
